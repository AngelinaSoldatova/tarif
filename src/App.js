...
const tarif = [
  ...
  { bezlimit: "Безлимитный 550", ryb: "руб 550/мес", doc: "до 100 Мбит/сек", isSelected: true },
...
class App extends React.Component {
  ...
  return (
    <div className="App">
      {
        tarif.map((tarif) =>
          <Tarif bezlimit={tarif.bezlimit} ryb={tarif.ryb} doc={tarif.doc} isSelected={tarif.isSelected} />
        )
      }
    </div>
  );
